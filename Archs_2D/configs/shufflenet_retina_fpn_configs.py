...
CONFIGS.FPN = CfgNode()
CONFIGS.FPN.IN_FEATURES = ['stage_2', 'stage_3', 'conv_5']
...
CONFIGS.DETECTOR.CHECKPOINT = './logdirs/shufflenet_retinanet/retinanet_mobilev3_107000.pkl'
...
@Register.Config.register('SHUFFLE-RETINA-FPN')
def register():
    return CONFIGS