...
class AnchorGenerator(object):
    ...
    def __init__(self, cfg, input_shapes: List[ShapeSpec]):
        super().__init__()
        # fmt: off
        sizes         = cfg.ANCHOR_GENERATOR.SIZES
        aspect_ratios = cfg.ANCHOR_GENERATOR.ASPECT_RATIOS
        self.strides  = [x.stride for x in input_shapes]
    ...
    def _calc_shapes(self, in_shapes, stride):
        n = math.log2(stride)
    ...
    def __call__(self, input_tensor_size):
        """
        Args:
